...
test( 'in the middle of a multi-item list', function() {
	tests.setHtmlWithSelection( '<dl><dt>x</dt><dd>foo[]</dd><dt>y</dt><d</dl>' );
	tests.editor.execCommand( 'enter' );
	assert.areSame( '<dl><dt>x</dt><dd>foo</dd><dt>[]</dt><dt>y</dt><d</dl>', tests.getHtmlWithSelection() );
} );
...
test( 'in the middle of a list', function() {
	...
	tests.editor.execCommand( 'enter' );
	assert.areSame( '<p>x</p><dl><dd>a</dd></dl><p>[]</p><dl><dd>b</dd></dl><p>y</p>', tests.getHtmlWithSelection() );
} );
